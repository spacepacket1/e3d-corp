...
const COMMANDS = [
  ...
  ['event verify [--instance <name>]', 'Verify the event log hash chain and report the first altered record'],
...
export function formatHelp() {
  ...
  lines.push(
    '',
    'Implemented so far: `config validate`, `event add`, `event log`, `event verify`, `run`, `pursue`, `opportunities list`, ' +
