...
import { normalizeProposalPayload, validateProposalInput } from './schema.js';
...
export function createProposal(
  ...
  const normalizedPayload = normalizeProposalPayload(type, payload, { proposalId: id, correlationId, createdAt });
  const record = {
    id,
    type,
