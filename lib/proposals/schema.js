import { CAPITAL_MANDATE_PROPOSAL_TYPE, normalizeCapitalMandatePayload } from './capitalMandateSchema.js';
...
export function normalizeProposalPayload(type, payload, context = {}) {
  if (type === CAPITAL_MANDATE_PROPOSAL_TYPE) {
    return normalizeCapitalMandatePayload(payload, context);
  }
  return payload;
}
