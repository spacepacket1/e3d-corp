...
<body>
<nav><a href="/opportunities">Opportunities</a><a href="/proposals">Proposals</a><a href="/actions">Actions</a></nav>
...
export function renderOpportunityDetail(opportunity, chain, { csrfToken, error } = {}) {
